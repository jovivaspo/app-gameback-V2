...
const Videogame = () => {
  const { id } = useParams();
  const { userVideogame, videogameApi, handleChange, handleSubmit, formEdit } =
    useVideogame(id);
  ...
  return (
    ...
    videogameApi && (
      <div
        className="videogame-background"
        style={{
          ...
          <div className="container videogame-container-info">
            ...
            <div className="row">
              <div className="col-md-6 game-info">
                <p>
                  <span className="main-tags">Platforms: </span>
                  <br />
                  <span className="info-tags">
                    {videogameApi.platforms?.map((el) => {
                      return el.platform.name + " ";
                    })}
                  </span>
                </p>
                <p>
                  <span className="main-tags">Publishers: </span>
                  <br />
                  <span className="info-tags">
                    {videogameApi.publishers?.map((el) => {
                      return el.name + " ";
                    })}
                  </span>
                </p>
                <p>
                  <span className="main-tags">Stores: </span>
                  <br />
                  <span className="info-tags">
                    {videogameApi.stores?.map((el) => {
                      return el.store.name + " ";
                    })}
                  </span>
                </p>
                <p>
                  <span className="main-tags">Global Rating: </span>
                  <br />
                  <span className="info-tags">{videogameApi?.rating}</span>
                </p>
                <p>
                  <span className="main-tags">Website: </span>
                  <br />
                  <a
                    className="info-tags"
                    target="_blank"
              ...
              <div className="col-md-6 game-info">
                <Form className="form-game" style={{ maxWidth: 400 }}>
                  ...
                  >
                    ...
                    >
                      <option style={{ color: "white", background: "#212529" }}>
                        Select
                      </option>
                      {rating.map((el, index) => {
                        return (
                          <option
                            key={index}
                            value={el}
                            style={{ color: "white", background: "#212529" }}
                          >
                            {el}
                          </option>
                        );
